          ...
          <div className="userSidebar__user">
            <div className="userSidebar__userImg">
              <Avatar
                ...
                alt={user ? userDoc?.fullname : user?.fullname}
                src={user && userDoc?.photo}
              >
                {user
                  ? user.fullname?.charAt(0).toUpperCase()
                  : userDoc?.fullname?.charAt(0).toUpperCase()}
              </Avatar>
            </div>
