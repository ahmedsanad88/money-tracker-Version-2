        ...
        if (operand.length > 0 ) {
            ...
            if (operand[0] === "+" || operand[0] === "-" || operand[0] === "/" || operand[0] === "*") {
                ...
                if (checkDoubleSign()) {
                    ...
                    if(checkPoints()) {
                        alert("Please check your equation did you added two dots Frequently or on the same group?");
                    }else {
    ...
    const checkPoints = () => {
        ...
        for (let i = 0; i < operand.length; i++) {
            if (operand[i] === ".") {
                ...
                if(i > 0) {
                    for (let j = i - 1; j >= 0; j--) {
                        if(operand[j] === "+" || operand[j] === "-" || operand[j] === "/" || operand[j] === "*") {
                            break;
                        }
                ...
                if(i < (operand.length - 1)) {
                    for (let k = i + 1; k < operand.length; k++) {
                        if(operand[k] === "+" || operand[k] === "-" || operand[k] === "/" || operand[k] === "*") {
                            break;
                        }
