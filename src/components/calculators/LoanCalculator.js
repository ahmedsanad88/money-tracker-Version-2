  ...
  const handleSubmit = (e) => {
    ...
    if (value1 && value2 && value3) {
      if (
        ...
        totalPayment = (parseInt(value1) + parseFloat(totalInterest)).toFixed(
          3
        );
    ...
    <div className="loanCalculator">
      ...
      <div className="loanCalculator_main">
        <div className="loanCalculator_input">
          <form>
            ...
            <input
              ...
              type="number"
              name="rate"
              placeholder="Interest Rate / Year(Max=40)"
              min="1"
              max="40"
              required
            ...
            <input
              ...
              type="number"
              name="tenor"
              placeholder="Tenor / Months(Max=300)"
              min="1"
              max="300"
              required
        ...
        <div className="loanCalculator_result">
          <p>
            Monthly Installment ={" "}
            <strong className="result">{results.installment}</strong>$
          </p>
          <p>
            Total Interest Amount ={" "}
            <strong className="result">{results.totalInterest}</strong>$
          </p>
          <p>
            Total Payment After Majority ={" "}
            <strong className="result">{results.totalPayment}</strong>$
          </p>
        </div>
      </div>
    </div>
